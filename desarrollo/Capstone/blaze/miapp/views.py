...
from .models import Dueño, Vehiculo, Reparacion, Trabajador, Cita, Pago, Servicio, Proceso
...
def mi_cuenta(request):
    user = request.user
    # Asumiendo que el RUT del dueño es el nombre de usuario
    dueño = Dueño.objects.filter(rut=user.username).first()
    vehiculos = Vehiculo.objects.filter(
        dueño_id_dueño=dueño.id_dueño) if dueño else []
    reparaciones = Reparacion.objects.filter(
        vehiculo__dueño_id_dueño=dueño.id_dueño) if dueño else []
    citas = Cita.objects.filter(
        vehiculo__dueño_id_dueño=dueño.id_dueño) if dueño else []
    pagos = Pago.objects.filter(
        reparacion__vehiculo__dueño_id_dueño=dueño.id_dueño) if dueño else []
...
def registrar_usuario(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Redirigir a la página de registro de dueño
...
def registrar_vehiculo(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            vehiculo.dueño = request.user.dueño  # Asignar al dueño que ha iniciado sesión
            vehiculo.save()
